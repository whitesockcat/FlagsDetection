...
# nvidia-smi;
# cp /userhome/apollo/detectron/datasets/dataset_catalog.py /detectron/detectron/datasets;
# ln -s /userhome/apollo/Apollo_2/ /detectron/detectron/datasets/data/coco;
# ln -s /userhome/apollo/city/ /detectron/detectron/datasets/data/cityscape;
...
#     OUTPUT_DIR /userhome/apollo/output_add_city
def parse_args():
